...
type Row = {
  label: string;
  org: { name: string; sub?: string; avatar?: string };
  startDate: string;
  status: string;
  progress?: string;
};
@Component({
  selector: 'app-org-diagnostic',
  imports: [CommonModule, UiDataTableComponent, UiOrgCellComponent, DtCellTemplateDirective],
  templateUrl: './org-diagnostic.component.html',
  styleUrl: './org-diagnostic.component.css',
})
export class OrgDiagnosticComponent {
  columns: TableColumn<Row>[] = [
    { key: 'label', header: 'Diagnostic Title', templateName: 'diagnostic', widthClass: 'w-[130px]' },
    { key: 'org', header: 'Assigned Helper', templateName: 'organization', widthClass: 'w-[160px]' },
    { key: 'startDate', header: 'Created Date', templateName: 'date', widthClass: 'w-[120px]' },
